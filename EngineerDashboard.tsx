...
import { DollarSignIcon, CalendarIcon, StarIcon, EditIcon, PhotoIcon, MicrophoneIcon } from './icons';
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="relative rounded-2xl overflow-hidden cardSurface group">
                {engineer.cover_image_url ? (
                    ...
                    <div className="w-full h-48 md:h-64 bg-gradient-to-br from-zinc-900 to-zinc-800" />
                )}
                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-6">
                        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-6">
                            <div className="relative group/pfp flex-shrink-0">
                                <img src={getProfileImageUrl(engineer)} alt={engineer.name} className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-zinc-800" />
                                <button 
