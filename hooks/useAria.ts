...
import type { Artist, Engineer, Stoodio, Producer, Booking, AriaActionResponse, AriaCantataMessage, Location, FileAttachment, Label, BookingRequest } from '../types';
            ...
            case 'generateDocument':
                if (command.value && currentUser) {
                    ...
                    try {
                        ...
                        deps.navigate(AppView.ARTIST_DASHBOARD); 
