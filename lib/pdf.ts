 ...
 * @param documentContent The text content to put in the PDF (undefined/empty treated as placeholder).
 * @returns A promise that resolves with the PDF file as a Uint8Array.
 */
export async function createPdfBytes(documentContent: string | undefined): Promise<Uint8Array> {
    const text = typeof documentContent === 'string' && documentContent.trim() ? documentContent : 'Document generated by Aria Cantata.';
