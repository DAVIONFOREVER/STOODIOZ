...
const StoodioSetup: React.FC<StoodioSetupProps> = ({ onCompleteSetup, onNavigate }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl border border-slate-200 shadow-xl">
            <h1 className="text-4xl font-extrabold text-center mb-2 text-slate-900">Create Your <span className="text-orange-500">Stoodio Profile</span></h1>
            <p className="text-center text-slate-500 mb-8">List your space for artists to discover and create your account.</p>
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-2">Stoodio Name</label>
                    <input
                        type="text"
                        id="name"
                        value={name}
                ...
                <div>
                    <label htmlFor="description" className="block text-sm font-medium text-slate-700 mb-2">Stoodio Description</label>
                    <textarea
                        id="description"
                        value={description}
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-2">Contact Email</label>
                        <input
                            type="email"
                            id="email"
                            value={email}
                    ...
                    <div>
                        <label htmlFor="password" aria-label="Password" className="block text-sm font-medium text-slate-700 mb-2">Account Password</label>
                        <input
                            type="password"
                            id="password"
                            value={password}
