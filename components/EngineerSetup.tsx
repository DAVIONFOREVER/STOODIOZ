...
const EngineerSetup: React.FC<EngineerSetupProps> = ({ onCompleteSetup, onNavigate }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl border border-slate-200 shadow-xl">
            <h1 className="text-4xl font-extrabold text-center mb-2 text-slate-900">Create Your <span className="text-orange-500">Engineer Profile</span></h1>
            <p className="text-center text-slate-500 mb-8">Showcase your skills, experience, and create your account.</p>
