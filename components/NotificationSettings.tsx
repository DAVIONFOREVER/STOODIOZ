        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <div>
                        <h3 className="font-semibold text-slate-800">Enable Job Alerts</h3>
                        <p className="text-sm text-slate-500">Receive push notifications for new opportunities.</p>
                    </div>
                    <label className="flex items-center cursor-pointer">
                        <div className="relative">
                            ...
                            />
                            <div className={`block w-12 h-6 rounded-full transition-colors ${prefs.enabled ? 'bg-orange-500' : 'bg-slate-300'}`}></div>
                ...
                {/* Radius Slider */}
                <div className={`bg-slate-50 p-4 rounded-lg border border-slate-200 transition-opacity ${prefs.enabled ? 'opacity-100' : 'opacity-50'}`}>
                    <div className="flex justify-between items-center mb-2">
                        <label htmlFor="radius-slider" className="font-semibold text-slate-800 flex items-center gap-2">
                           <RoadIcon className="w-5 h-5"/> Notification Radius
                        </label>
                        <span className="font-bold text-orange-500">{prefs.radius} miles</span>
                    </div>
                ...
                {/* Minimum Pay Rate */}
                 <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <div className="flex justify-between items-center mb-2">
                        <label htmlFor="pay-rate-input" className="font-semibold text-slate-800 flex items-center gap-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-7 pr-12 bg-white border-slate-300 rounded-md py-2"
                            placeholder="e.g., 50"
                            min="0"
                        />
