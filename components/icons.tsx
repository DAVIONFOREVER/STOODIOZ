...
export const StoodiozLogoIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M50 5 L95 27.5 L95 72.5 L50 95 L5 72.5 L5 27.5 Z" stroke="currentColor" strokeWidth="5" fill="none" />
...
export const MapIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503-6.998l-6.878 2.3a.75.75 0 00-.44 1.05l1.01 2.42a.75.75 0 001.05.44l6.878-2.3a.75.75 0 00.44-1.05l-1.01-2.42a.75.75 0 00-1.05-.44zM4.5 19.5l15-6" />
    </svg>
);
...
export const SoundWaveIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h7.5v10.5h-7.5V6.75zM12 3v3.75m0 10.5V21m-3.75-9.75H3v3.75h5.25V12zm9.75 0H21v3.75h-5.25V12z" />
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.512 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m7.512 2.72a8.97 8.97 0 00-6.916-2.922 8.97 8.97 0 00-6.916 2.922m0 0A9.06 9.06 0 0112 21a9.06 9.06 0 016.258-2.28M15 7.5a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const DurationIcon: React.FC<IconProps> = ClockIcon;
...
export const UserGroupIcon: React.FC<IconProps> = UsersIcon;
...
export const CogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5" />
    </svg>
);
...
export const AlertTriangleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v4m0 4h.01M10.29 3.86l-7.5 13A1.5 1.5 0 004.1 19h15.8a1.5 1.5 0 001.3-2.24l-7.5-13a1.5 1.5 0 00-2.6 0z" />
    </svg>
);
...
export const SmokingIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v7.5A2.25 2.25 0 005.25 18h5.25m-6-3h9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 6h-3m3 3h-3m-3.75 3h6.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-3" />
  </svg>
);
...
export const NoSmokingIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v7.5A2.25 2.25 0 005.25 18h5.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 6h-3m3 3h-3m-3.75 3h6.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-3" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.441-2.22 2.625a2.25 2.25 0 01-2.53-1.928v-3.411c0-.788.636-1.425 1.425-1.425h3.325c.788 0 1.425.636 1.425 1.425z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 9.75v-4.125c0-1.313-.964-2.441-2.22-2.625a2.25 2.25 0 00-2.53 1.928v3.411c0 .788.636 1.425 1.425 1.425h3.325c.788 0 1.425.636 1.425-1.425z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5c0-.788.636-1.425 1.425-1.425h3.325c.788 0 1.425.636 1.425 1.425V21" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 16.5h3.375m-3.375 0V7.5h3.375v9zM5.25 3v3.75m4.125 0V3m-4.125 0H9.375m-4.125 0a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25m-4.125 0h7.5m-7.5 0c0 1.104.896 2.062 2.062 2.062h3.375c1.166 0 2.062-.958 2.062-2.062m-7.5 0v3.75" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.405l-4.098.93a.75.75 0 01-.93-.93l.93-4.098a9.76 9.76 0 01-.405-2.53C2.25 16.03 6 12 6 12s3.75 0 3.75-3.75S6 4.5 6 4.5c0-1.884 1.414-3.414 3.182-3.414a5.25 5.25 0 015.25 5.25c0 3.75 3.75 3.75 3.75 3.75z" />
    </svg>
);
...
export const PauseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path
            fillRule="evenodd"
            d="M6.75 5.25A.75.75 0 017.5 4.5h1.5a.75.75 0 01.75.75v13.5a.75.75 0 01-.75.75H7.5a.75.75 0 01-.75-.75V5.25zm7.5 0a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v13.5a.75.75 0 01-.75.75h-1.5a.75.75 0 01-.75-.75V5.25z"
            clipRule="evenodd"
        />
    </svg>
);
...
export const EditIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 19.82a2.25 2.25 0 01-1.06.607l-4.5 1.5a.75.75 0 01-.939-.939l1.5-4.5a2.25 2.25 0 01.607-1.06L16.862 4.487zm0 0L19.5 7.125" />
    </svg>
);
...
// FIX: Added missing LockClosedIcon component export
