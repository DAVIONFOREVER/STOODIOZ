        ...
        <div>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                 <div className="bg-black/50 backdrop-blur-md rounded-2xl p-8 border border-orange-500/20 shadow-[0_0_30px_rgba(249,115,22,0.15)]">
                    <p className="text-slate-300 leading-relaxed text-center mb-6">{engineer.bio}</p>
                    <div className="flex justify-center flex-wrap gap-2">
                     ...
                     <div>
                        <h3 className="text-xl font-bold mb-3 text-orange-400 flex items-center justify-center gap-2"><CogIcon className="w-6 h-6"/>Specialties</h3>
