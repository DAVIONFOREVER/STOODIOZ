                ...
                <div className="lg:col-span-2 space-y-8">
                     <div className="p-6 cardSurface sticky top-28">
                        ...
                        <div className="space-y-4">
                            ...
                            <button onClick={handleBookClick} disabled={!currentUser} className="w-full bg-orange-500 text-white font-bold py-3 rounded-lg hover:bg-orange-600 transition-all disabled:bg-zinc-700 disabled:text-zinc-500 disabled:cursor-not-allowed">
                                Find a Stoodio
                            </button>
                        </div>
                    </div>
