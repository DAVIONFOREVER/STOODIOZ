...
const AnimatedSlide: React.FC<{ slide: Slide; isActive: boolean }> = ({ slide, isActive }) => {
    const commonWrapperClass = `absolute inset-0 bg-zinc-900/50 p-4 sm:p-6 flex items-center justify-center transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`;
