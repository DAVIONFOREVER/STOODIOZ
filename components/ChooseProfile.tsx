...
const RoleCard: React.FC<{
    ...
    <button
        onClick={onClick}
        className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-orange-500 hover:bg-slate-50 transition-all duration-300 text-left w-full group shadow-lg"
    >
        ...
        <span className="font-semibold text-orange-500 flex items-center gap-2 group-hover:gap-3 transition-all">
    ...
    return (
        <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900">
                How will you use <span className="text-orange-500">Stoodioz?</span>
            </h1>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-1 gap-8">
                <RoleCard
                    icon={<MicrophoneIcon className="w-10 h-10 text-green-500" />}
                    title="Artist"
                ...
                />
                <RoleCard
                    icon={<SoundWaveIcon className="w-10 h-10 text-orange-500" />}
                    title="Engineer"
                ...
                />
                <RoleCard
                    icon={<HouseIcon className="w-10 h-10 text-red-500" />}
                    title="Stoodio Owner"
