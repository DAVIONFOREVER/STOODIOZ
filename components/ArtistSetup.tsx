...
const ArtistSetup: React.FC<ArtistSetupProps> = ({ onCompleteSetup, onNavigate }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto bg-zinc-800 p-8 rounded-2xl border border-zinc-700">
            <h1 className="text-4xl font-extrabold text-center mb-2 text-orange-500">Create Your Artist Profile</h1>
            <p className="text-center text-slate-400 mb-8">Tell the community who you are and create your account.</p>
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium text-slate-300 mb-2">Artist/Band Name</label>
                    <input
                        type="text"
                        id="name"
                        value={name}
