...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onBack }) => {
    return (
        <div className="max-w-4xl mx-auto bg-zinc-900/70 backdrop-blur-lg p-8 rounded-2xl border border-zinc-700/50 shadow-2xl animate-fade-in">
            ...
            <div className="prose prose-invert prose-headings:font-bold prose-headings:text-orange-400 prose-a:text-orange-400 max-w-none">
                ...
                <h2 className="text-red-500">5. Disclaimer of Warranties and Limitation of Liability</h2>
                ...
                <p>You are responsible for the accuracy of your profile information and for your interactions with other users. Stoodioz acts as a marketplace to connect users and is not a party to any direct agreement between an Artist and an Engineer or a Stoodio.</p>
