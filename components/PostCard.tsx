...
const PostCard: React.FC<PostCardProps> = ({ post, author, onLikePost, onCommentOnPost, onSelectAuthor }) => {
    ...
    return (
        <div className="bg-black/50 backdrop-blur-md rounded-2xl shadow-[0_0_20px_rgba(249,115,22,0.1)] border border-orange-500/20">
            <div className="p-6">
                {/* Post Header */}
                <div className="flex items-start justify-between gap-4 mb-4">
                    ...
                    <div className="relative" ref={menuRef}>
                        ...
                        {isMenuOpen && (
                            <div className="absolute top-full right-0 mt-1 w-40 bg-zinc-800 rounded-md shadow-lg z-10 border border-zinc-700">
                                <button onClick={handleReport} className="w-full flex items-center gap-2 px-3 py-2 text-sm text-slate-200 hover:bg-zinc-700">
            ...
            {/* Post Actions */}
            <div className="border-t border-orange-500/20 mx-4 sm:mx-6 py-1 flex justify-around items-center text-slate-400">
                <button
            ...
            {/* Comments Section */}
            {showComments && (
                <div className="border-t border-orange-500/20 p-6 space-y-4 bg-black/30 rounded-b-2xl">
