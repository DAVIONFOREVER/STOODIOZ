...
const Header: React.FC<HeaderProps> = (props) => {
    ...
    const { userRole, notifications, artists, engineers, producers, stoodioz, currentUser, history, historyIndex } = useAppState();
    ...
    const handleLogoClick = () => {
        const setupViews = [AppView.ARTIST_SETUP, AppView.ENGINEER_SETUP, AppView.PRODUCER_SETUP, AppView.STOODIO_SETUP, AppView.LABEL_SETUP];
