...
const RankedUserCard: React.FC<RankedUserCardProps> = ({ profile, rank, isSpotlight = false, onSelectProfile }) => {
        ...
        return (
            ...
            >
                <div className="relative flex-shrink-0">
                    ...
                    <img src={getProfileImageUrl(profile)} alt={profile.name} className="w-32 h-32 rounded-full object-cover border-4 border-zinc-700" />
    ...
    return (
        ...
        >
            ...
            {/* FIX: Changed `imageUrl` to `image_url` to match the profile type definition. */}
            <img src={getProfileImageUrl(profile)} alt={profile.name} className="w-16 h-16 rounded-lg object-cover flex-shrink-0" />
