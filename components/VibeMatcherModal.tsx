            ...
            <div className="bg-zinc-800 rounded-xl shadow-2xl w-full max-w-lg transform animate-slide-up border border-zinc-700" role="dialog" aria-modal="true">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-6 bg-zinc-800/50 border-t border-zinc-700 rounded-b-xl flex justify-end">
                        ...
                        <button type="submit" disabled={!songUrl.trim() || isLoading} className="text-white bg-orange-500 hover:bg-orange-600 disabled:bg-slate-500 disabled:cursor-not-allowed focus:ring-4 focus:outline-none focus:ring-orange-300 font-bold rounded-lg text-sm px-5 py-3 text-center transition-all shadow-md w-40">
