    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="max-w-2xl mx-auto mb-12 p-4 bg-zinc-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-zinc-700/50">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                               <LocationIcon className="h-5 w-5 text-zinc-400" />
                            </div>
                            <input
                                type="text"
                                id="zip-code"
                ...
                <div className="mt-4 border-t border-zinc-700/50 pt-4 flex flex-col sm:flex-row justify-between items-center gap-4">
                    {searchLocation && (
                        <div className="w-full sm:w-2/3">
                            <label htmlFor="radius-slider" className="block text-center text-sm font-medium text-zinc-300 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             ...
             {searchLocation && filteredStoodioz.length === 0 && (
                <p className="text-center text-zinc-400 mt-8">No stoodioz found. Try increasing the search radius or changing filters.</p>
            )}
        </div>
    );
};
