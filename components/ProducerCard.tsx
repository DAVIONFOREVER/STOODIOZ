        ...
        >
            <div className="relative z-10">
                <button onClick={() => onSelectProducer(producer)} className="w-full text-center">
                    ...
                    <h3 className="text-xl font-bold text-slate-100 mt-4 group-hover:text-purple-400 text-glow">{producer.name}</h3>
