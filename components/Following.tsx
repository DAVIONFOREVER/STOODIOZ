                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {studios.map(studio => (
                                <div key={studio.id} className="cardSurface p-3 flex items-center gap-4">
                                    ...
                                    <img src={getProfileImageUrl(studio)} alt={studio.name} className="w-16 h-16 object-cover rounded-lg flex-shrink-0" />
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {engineers.map(engineer => (
                                <div key={engineer.id} className="cardSurface p-3 flex items-center gap-4">
                                    {/* FIX: Corrected property 'imageUrl' to 'image_url' to match the user type definition. */}
                                    <img src={getProfileImageUrl(engineer)} alt={engineer.name} className="w-16 h-16 object-cover rounded-lg flex-shrink-0" />
                                    <div className="flex-grow">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {artists.map(artist => (
                                <div key={artist.id} className="cardSurface p-3 flex items-center gap-4">
                                    {/* FIX: Corrected property 'imageUrl' to 'image_url' to match the user type definition. */}
                                    <img src={getProfileImageUrl(artist)} alt={artist.name} className="w-16 h-16 object-cover rounded-lg flex-shrink-0" />
                                    <div className="flex-grow">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {producers.map(producer => (
                                <div key={producer.id} className="cardSurface p-3 flex items-center gap-4">
                                    {/* FIX: Corrected property 'imageUrl' to 'image_url' to match the user type definition. */}
                                    <img src={getProfileImageUrl(producer)} alt={producer.name} className="w-16 h-16 object-cover rounded-lg flex-shrink-0" />
                                    <div className="flex-grow">
