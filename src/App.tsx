...
const App: React.FC = () => {
    ...
    // Defined BEFORE renderView to be accessible
    ...
    // Defined BEFORE renderViewProxy
    const renderView = () => {
        switch (currentView) {
    ...
    // --- VIEW PROXY ---
    // Defined AFTER renderView because it calls renderView
