    ...
    return (
        <div className="max-w-md mx-auto p-8 mt-16 cardSurface">
            ...
            <div className="mt-4 text-center">
                <button 
                    onClick={() => onNavigate(AppView.CLAIM_LABEL_PROFILE)} 
                    className="text-sm text-zinc-400 hover:text-orange-400 underline decoration-dotted hover:decoration-solid transition-all"
                >
                    Were you added to a label’s roster? Claim your profile
                </button>
            </div>

             <div className="text-center mt-6 border-t border-zinc-700 pt-6">
