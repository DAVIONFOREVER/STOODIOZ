...
const LabelBudgetDashboard: React.FC = () => {
    ...
    const handleSaveTotalBudget = async () => {
        if (!currentUser) return;
        try {
            await apiService.setLabelBudget(currentUser.id, newTotalBudget);
    ...
    const handleSaveAllocation = async (artistId: string) => {
        if (!currentUser) return;
        try {
            await apiService.setArtistAllocation(currentUser.id, artistId, newAllocation);
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-zinc-500">Calculating financial data...</p>
            </div>
        );
    }
        ...
        <div className="space-y-8 animate-fade-in">
                        ...
                        <div>
                            ...
                            {isEditingTotal ? (
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <h2 className="text-3xl font-extrabold text-zinc-100">${totalBudget.toLocaleString()}</h2>
                ...
                <div className="cardSurface p-6 border-l-4 border-blue-500">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h2 className="text-3xl font-extrabold text-zinc-100 mt-1">${totalSpent.toLocaleString()}</h2>
                        </div>
            ...
            <div className="cardSurface p-6">
                <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="text-zinc-400">{percentSpent.toFixed(1)}% Used</span>
                </div>
                        ...
                        return (
                            <div key={artist.artist_id} className="cardSurface p-5 flex flex-col md:flex-row items-center gap-6">
                                <div className="flex items-center gap-4 w-full md:w-1/3">
                                    <img src={artist.artist_image_url} alt={artist.artist_name} className="w-12 h-12 rounded-full object-cover border-2 border-zinc-700" />
                                    <div>
                                ...
                                <div className="flex-grow w-full md:w-1/3">
                                    <div className="flex justify-between text-xs mb-1">
                                        <span className="text-zinc-400">Spent: ${artist.amount_spent.toLocaleString()}</span>
                                ...
                                <div className="w-full md:w-auto flex flex-col items-end min-w-[150px]">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-lg font-bold text-zinc-100">${artist.allocation_amount.toLocaleString()}</span>
