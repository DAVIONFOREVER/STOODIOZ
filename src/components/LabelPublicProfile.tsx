...
const LabelPublicProfile: React.FC = () => {
    ...
    // To strictly follow "Modify existing files only", we can't easily add `selectedLabel` to AppContext without editing Context too much.
    // So we will simulate a label object here or use `currentUser` if they are viewing their own profile.
