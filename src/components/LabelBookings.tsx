...
const MOCK_ARTISTS: MockArtist[] = [
    { id: 'a1', name: 'Beyoncé', image_url: 'https://upload.wikimedia.org/wikipedia/commons/1/17/Beyonc%C3%A9_at_The_Lion_King_European_Premiere_2019.png' },
    { id: 'a2', name: 'Travis Scott', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Travis_Scott_2016.jpg/800px-Travis_Scott_2016.jpg' },
    { id: 'a3', name: 'Harry Styles', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Harry_Styles_Love_on_Tour_2022.jpg/800px-Harry_Styles_Love_on_Tour_2022.jpg' },
    { id: 'a4', name: 'Doja Cat', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Doja_Cat_at_Global_Citizen_Festival_2023_%2853213554761%29_%28cropped%29.jpg/640px-Doja_Cat_at_Global_Citizen_Festival_2023_%2853213554761%29_%28cropped%29.jpg' },
    { id: 'a5', name: 'Future', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Future_2014.jpg/800px-Future_2014.jpg' },
];
